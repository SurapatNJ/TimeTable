...
class App extends Component{
  ...
  callAPI(){
      fetch("http://localhost:9000/testAPI/mysqldb")
          .then(res => res.text())
  ...
  //   fetch(`http://localhost:9000/testAPI/mysqldb/add?insertdata=${this.state.username}`)
  //   .then(this.callAPI())
  // }
  ...
  deleteData = _ => {
    fetch(`http://localhost:9000/testAPI/mysqldb/delete?insertdata=${this.state.username}`)
    .then(this.callAPI())
  }

  clearData = _ => {
    fetch(`http://localhost:9000/testAPI/mysqldb/truncate`)
    .then(this.callAPI())
  }
